...
<pre style="position: relative;"><strong>Input:</strong> startValue = 2, target = 3
...
<pre style="position: relative;"><strong>Input:</strong> startValue = 5, target = 8
<strong>Output:</strong> 2
...
<pre style="position: relative;"><strong>Input:</strong> startValue = 3, target = 10
